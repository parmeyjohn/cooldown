...
const Sidebar = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
      ...
      >
        <div
          id="navigation"
          className="w-full flex justify-between border-solid border-b-2 border-slate-300"
        >
          ...
          <button onClick={() => setShowSidebar(false)} className="">
            <svg
              ...
              strokeWidth={2}
              stroke="currentColor"
              className="w-12 h-12 p-2 hover:bg-slate-400 hover:rounded-lg active:bg-slate-500 mr-5 "
            >
              <path
                strokeLinecap="round"
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div>
            <div
              id="newJournal"
              className="flex justify-between pl-4 py-4 px-4 border-solid border-b-2 border-slate-300"
            >
              <input
                className="bg-slate-300 p-2 ml-2 mb-2 w-[75%] shadow-inner shadow-slate-400  outline-8 focus:outline-offset-1 focus:outline-teal-700 focus:bg-teal-50 focus:shadow-none rounded-lg transition ease-in-out duration-300"
                type="text"
                name="new-journal"
